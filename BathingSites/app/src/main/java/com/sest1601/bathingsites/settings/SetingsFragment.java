...
public class SetingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Find the GPS pref and set its summary to pref value
        pref = findPreference(getString(R.string.pref_key_GPSradius));
        prefText = (EditTextPreference) pref;
        pref.setSummary(prefText.getText());
        ...
        reset.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                Preference gpsSetting = findPreference(getString(R.string.pref_key_GPSradius));
                ((EditTextPreference) gpsSetting).setText(getString(R.string.pref_key_GPSradiusDEFAULT));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if(key.equals(getString(R.string.pref_key_GPSradius))) {
            Preference pref = findPreference(getString(R.string.pref_key_GPSradius));
            EditTextPreference prefText = (EditTextPreference) pref;
            pref.setSummary(prefText.getText());
        }
